...
const Contact = () => {
    ...
    const ContactCard = ({ icon, title, value }) => (
        <div className="flex items-center p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#E0E5E] shadow-[9px_9px_16px_#bec3c9,-9px_-9px_16px_#ffffff] transition-all hover:shadow-[inset_9px_9px_16px_#bec3c9,inset_-9px_-9px_16px_#ffffff] duration-300">
            <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl mr-3 sm:mr-4 bg-[#E0E5E] shadow-[5px_5px_10px_#bec3c9,-5px_-5px_10px_#ffffff]">
                {icon}
            </div>
            <div>
    ...
    return (
        <section id="contact" className=" lg:py-28 min-h-screen px-6 py-20 sm:py-20 md:py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="max-w-5xl mx-auto text-center mb-8 sm:mb-12">
                    ...
                    <div className="text-center mb-12 sm:mb-16">
                        ...
                        <div className="text-gray-500 text-base sm:text-lg px-2">
